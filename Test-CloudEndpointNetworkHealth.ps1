...
.EXAMPLE
    ...
    .\Test-CloudEndpointNetworkHealth.ps1 -Workload Intune -Mode 2
    .\Test-CloudEndpointNetworkHealth.ps1 -Workload Windows365 -Mode 1
    .\Test-CloudEndpointNetworkHealth.ps1 -Workload AVD -Mode 3
    .\Test-CloudEndpointNetworkHealth.ps1 -Workload All -Mode 3 -OutputPath C:\Temp\results.csv
...
# CONFIGURATION
# -----------------------------------------------------------------------------
$ScriptName     = 'Test-CloudEndpointNetworkHealth'
$ScriptVersion  = 'v4.1'
